""" Generate an ensemble of backbone configurations for a protein using a simplified protein model consisting of only C_alpha atoms. The ensemble is written to a trajectory file.
"""
